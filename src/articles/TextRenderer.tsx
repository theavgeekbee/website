...
export function TextRendererArticle() {
    ...
    if (language === "Java") {
        return (
            ...
            <div className={"article"}>
                ...
                <p>
                    In the making of my <a href={"https://github.com/InfinitePower563/tracon-simulator"}>TRACON Simulator</a>,
                    I had to make a text renderer by loading a font from a .ttf file in LWJGL.
                    The main way to do this was to use the FreeType library. I tried to use it, but after countless hours of
                ...
                <ol>
                    <li>
                        First, I needed to load the font file. I created a class called <code>VRCFont</code> (since I was using
                        VRC.ttf from the VRC client) that would load the font file. Although very rudimentary, this method is easier
                        ...
                        <ul>
                            <li>
                                ...
                                <div className={"code-block"}>
                                    ...
                                    Font font = Font.createFont(Font.TRUETYPE_FONT, stream).deriveFont(Font.PLAIN, size);<br />
                                </div>
                            </li>
                            <li>
                                I then draw the code to a <code>BufferedImage</code> which I can save in a temporary folder.
                                <div className={"code-block"}>
                                    for (char c : chars) &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;if (font.canDisplay(c)) &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String fileName;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (Arrays.toString(letters).contains("" + c)) &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fileName = c + "C";<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;else &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fileName = "" + c;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (c == '*') fileName = "asterisk";<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Loading bitmap texture " + c);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;createFile("/resources/bitmap/" + fileName + ".png");<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;drawImage(size, c, font, fileName);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Finished drawing bitmap texture " + c);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&#125;<br />
                                    &#125;
                                </div>
                            </li>
                            <li>
                                ...
                                <div className={"code-block"}>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;int y = ((size - fm.getHeight()) / 2) + fm.getAscent();<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;g2d.drawString("" + c, x, y);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;g2d.dispose();<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;ImageIO.write(image, "png", new File("src/main/resources/bitmap/" + fileName + ".png"));<br />
                                    &#125;
                                </div>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <div className={"code-block"}>public record Alias(ByteBuffer buf, int width, int height)</div>
                            </li>
                            <li>
                                Then, I created a method to load the textures
                                <div className={"code-block"}>
                                    for (char c : chars) &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;try (MemoryStack stack = MemoryStack.stackPush()) &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Generating alias for " + c);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String filePath = Character.isUpperCase(c) ? "src/main/resources/bitmap/" + c + "C.png" : "src/main/resources/bitmap/" + c + ".png";<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (c == '*') filePath = "src/main/resources/bitmap/asterisk.png";<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IntBuffer widthBuffer = stack.mallocInt(1);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IntBuffer heightBuffer = stack.mallocInt(1);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IntBuffer channelsBuffer = stack.mallocInt(1);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ByteBuffer imageBuffer = STBImage.stbi_load(filePath, widthBuffer, heightBuffer, channelsBuffer, 4);<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (imageBuffer == null) &#123;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new RuntimeException("Failed to load texture image: " + STBImage.stbi_failure_reason());<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;alias.put(c, new Alias(imageBuffer, widthBuffer.get(), heightBuffer.get()));<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&#125;<br />
                                    &#125;
                                </div>
                            </li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div className={"code-block"}>
                                    ...
                                    <br />
                                    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, a.buf());<br />
                                    <br />
                    ...
                    <li>
                        ...
                        <div className={"code-block"}>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;for (File f : Objects.requireNonNull(file.listFiles())) &#123;<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (f.getName().endsWith(".png")) &#123;<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!f.delete()) System.out.println("Failed to delete file " + f.getAbsolutePath());<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else System.out.println("Cleaned file " + f.getAbsolutePath());<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;<br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&#125;<br />
                            &#125;
                        </div>
                ...
                <ol>
                    <li>Make sure you have LWJGL and JOML imported in Gradle. Also ensure that STB is imported alongside LWJGL.</li>
                    <li>In your initialization script, call <code>TextRenderer.init();</code></li>
                    <li>In your render loop, when you want to draw text, call <code>TextRenderer.renderText</code> with the appropriate arguments.</li>
                    <li>Finally, in your shutdown script, call <code>TextRenderer.cleanupAlias()</code> <b>AND</b> <code>VRCFont.cleanupBitmaps()</code></li>
                </ol>
            </div>
            </div>
        );
    ...
    <div className="App-nav">
        ...
        <div>
            ...
            <>
                The C++ implementation is currently a work in progress. If you want to see the Java implementation for clues,
